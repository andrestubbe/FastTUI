...
public class Window {
    ...
    public static void main(String[] args) {
        ...
        fasttui.component.Window dashboard = new fasttui.component.Window(dashX, dashY, dashW, dashH, PANEL_BG_COLOR);
        dashboard.setBorderStyle(fasttui.component.Window.BorderStyle.ROUNDED);
        ...
        navigator.setBackgroundColor(PANEL_BG_COLOR);     // Normal window background
        navigator.setForegroundColor(0x18181B);           // Crisp Dark Zinc text
        ...
        AnsiMouse mouse = AnsiMouse.open(new FastMouseListener() {
            ...
            public void onMouseMove(long deviceHandle, int deltaX, int deltaY, int absX, int absY) {
                ...
                if (isResizing) {
                    ...
                    EventDispatcher.dispatchMouseMove(dashboard, cellX, cellY);
                }
            }
            ...
            public void onMouseButton(long deviceHandle, int buttonId, boolean isPressed) {
                        ...
                        if (dashboard.isMinimized()) {
                            ...
                            if (dashboard.isResizeClick(mouseCellX, mouseCellY)) {
                                ...
                                if (dashboard.isCloseClick(mouseCellX, mouseCellY)) {
                                    ...
                                    // Do nothing here, let EventDispatcher handle the button click
                                } else {
                                    isDragging = true;
                ...
                if (!isDragging) {
                    EventDispatcher.dispatchMouseClick(dashboard, mouseCellX, mouseCellY, isPressed);
                }
            }
