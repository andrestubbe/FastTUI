...
import fasttui.behaviour.ComplexButtonBehaviour;
import fasttui.behaviour.ComplexButtonBehaviour.State;
...
public class ComplexButton extends Control {
    ...
    private final ComplexButtonBehaviour behaviour;
    private Alignment alignment = Alignment.CENTER;

    private final Box box;
    private final TextArea label;

    public ComplexButton(int x, int y, int width, int height, String text, Runnable action) {
        ...
        this.behaviour = new ComplexButtonBehaviour(action);
